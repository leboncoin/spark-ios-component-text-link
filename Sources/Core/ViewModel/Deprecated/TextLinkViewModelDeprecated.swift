//
//  TextLinkViewModelDeprecated.swift
...
class TextLinkViewModelDeprecated: ObservableObject {
    ...
    let getColorUseCase: TextLinkGetColorUseCaseDeprecatedable
    let getDimUseCase: TextLinkGetDimUseCaseDeprecatedable
    let getHoverStyleUseCase: TextLinkGetHoverStyleUseCaseDeprecatedable
    let getTypographiesUseCase: TextLinkGetTypographiesUseCaseDeprecatedable
    let getAttributedStringUseCase: TextLinkGetAttributedStringUseCaseDeprecatedable
    let getImageSizeUseCase: TextLinkGetImageSizeUseCaseDeprecatedable
    ...
    init(
        ...
        getColorUseCase: TextLinkGetColorUseCaseDeprecatedable = TextLinkGetColorUseCaseDeprecated(),
        getDimUseCase: TextLinkGetDimUseCaseDeprecatedable = TextLinkGetDimUseCaseDeprecated(),
        getHoverStyleUseCase: TextLinkGetHoverStyleUseCaseDeprecatedable = TextLinkGetHoverStyleUseCaseDeprecated(),
        getTypographiesUseCase: TextLinkGetTypographiesUseCaseDeprecatedable = TextLinkGetTypographiesUseCaseDeprecated(),
        getAttributedStringUseCase: TextLinkGetAttributedStringUseCaseDeprecatedable = TextLinkGetAttributedStringUseCaseDeprecated(),
        getImageSizeUseCase: TextLinkGetImageSizeUseCaseDeprecatedable = TextLinkGetImageSizeUseCaseDeprecated()
    ) {
